  ...
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-display font-bold text-slate-900" data-testid="text-clients-heading">Clients</h1>
          <p className="text-slate-500 mt-1 font-body">Manage your clients and view their meetings.</p>
        </div>
