...
export async function migrateSiteImages() {
  try {
    ...
    const slots: SlotDef[] = [
      ...
      { key: "feature_record_anywhere", label: "Feature: Record Anywhere", section: "Features", description: "Image strip inside the 'Record Anywhere' feature card", w: 600, h: 260, url: "https://cdn.prod.website-files.com/670a67727905d0e6bd612d79/69a032b28b63023b38615aad_subscriptions-mockup.avif" },
