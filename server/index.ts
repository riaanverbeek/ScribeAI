...
import { backfillTenantIds, cleanupStaleUploads, migrateTemplateTenants, migrateDefaultAudioLanguage, retryStaleProcessing } from "./migrations";
...
(async () => {
  ...
  await migrateDefaultAudioLanguage();
